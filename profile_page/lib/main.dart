  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        scaffoldBackgroundColor: const Color(0xFFF1F8E9), // Warna hijau sangat soft
      ),
      ...
      body: Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [
              Color(0xFFE8F5E9), // Hijau sangat muda di atas
              Color(0xFFC8E6C9), // Sedikit lebih gelap di bawah
            ],
          ),
        ),
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: const [
                  Expanded(child: _StatBox(label: 'Post', value: '6')),
                  Expanded(child: _StatBox(label: 'Teman', value: '6')),
                  Expanded(child: _StatBox(label: 'Like', value: '66')),
                ],
              ),
              ...
              _SectionCard(
                ...
                content: Wrap(
                  ...
                  runSpacing: 4,
                  children: const [
                    Chip(label: Text('Jaringan')),
                    Chip(label: Text('Game')),
                    Chip(label: Text('Desain')),
                    Chip(label: Text('Tester')),
